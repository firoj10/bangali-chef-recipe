...
<h4>Let your tastebuds be your guide! Use our Customize <br/>It tool to make your meals feel truly yours</h4>
            ...
            <Col sm={12} md={6}><h2 className='text-success'>Select Your Preferences
</h2>
<h4>Every week, choose from over 30 meals and 18 Extras. Don’t need a box this week?.</h4>
            ...
            <Col className='pt-4' sm={12} md={6}><h2 className='text-success'>Delivered to Your Doorstep
</h2>
<h4>Delivered to Your Doorstep meals and 18 Extras.</h4>
</Col>
      </Row>
